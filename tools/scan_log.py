...
KNOWN = [
    ...
    ("REGRESSION", "DJN/SNH no-religious_school is BACK (maliki fix regressed)",
     r"initialize_from_bookmark\.cpp:520.*'(DJN|SNH)"),
    # -------------------------------------------------- ACCEPTED ---
    ("ACCEPTED", "landed/landless color twins (by design: PGN/TNG KDR/MAJ DBU/TIB)",
     r"utility\.h:242.*(PGN has same color as TNG|KDR has same color as MAJ|DBU has same color as TIB)"),
    ("ACCEPTED", "CHI already-has three_departments self-heal (512)",
